...
unsigned int __list_type_88(void* unused);
unsigned int __list_type_89(void* unused);
NULLCRef  list_node__value__auto_ref_ref__(list_node * __context)
{
...
NULLCRef  list_node__value__auto_ref_ref_auto_ref_(NULLCRef val_0, list_node * __context)
{
	...
	char_35_ __temp3_52;
	char_2_ __temp4_88;
	*(&listParent_12) = (list * )__nullcGetAutoRef(*(&(*(&__context))->parent), __nullcTR[109]);
	if((!(*(&(*(&listParent_12))->anyType))) && (__operatorNEqual(typeid__(*(&val_0), (void*)0), isPointer(*(&(*(&listParent_12))->elemType), (void*)0) ? typeid__subType_typeid_ref__(&(*(&listParent_12))->elemType) : *(&(*(&listParent_12))->elemType), (void*)0)))
	{
		assert(0, __operatorAdd(__operatorAdd(__operatorAdd(__operatorAdd((memcpy((&__temp2_20)->ptr, "list_node.value argument type (\x0", 32), __makeNullcArray<char >(&__temp2_20, 32)), (*(&__temp1_16) = typeid__(*(&val_0), (void*)0), typeid__name__char___ref__(&__temp1_16)), (void*)0), (memcpy((&__temp3_52)->ptr, ") differs from list element type (\x0\x0", 36), __makeNullcArray<char >(&__temp3_52, 35)), (void*)0), typeid__name__char___ref__(&(*(&listParent_12))->elemType), (void*)0), (memcpy((&__temp4_88)->ptr, ")\x0\x0\x0", 4), __makeNullcArray<char >(&__temp4_88, 2)), (void*)0), (void*)0);
	}
...
void  list__push_back_void_ref_auto_ref_(NULLCRef elem_0, list * __context)
{
	...
	{
		assert(0, __operatorAdd(__operatorAdd(__operatorAdd(__operatorAdd((memcpy((&__temp6_16)->ptr, "list::push_back argument type (\x0", 32), __makeNullcArray<char >(&__temp6_16, 32)), (*(&__temp5_12) = typeid__(*(&elem_0), (void*)0), typeid__name__char___ref__(&__temp5_12)), (void*)0), (memcpy((&__temp7_48)->ptr, ") differs from list element type (\x0\x0", 36), __makeNullcArray<char >(&__temp7_48, 35)), (void*)0), typeid__name__char___ref__(&(*(&__context))->elemType), (void*)0), (memcpy((&__temp8_84)->ptr, ")\x0\x0\x0", 4), __makeNullcArray<char >(&__temp8_84, 2)), (void*)0), (void*)0);
	}
	if(!(*(&(*(&__context))->first)))
	{
		*(&(*(&__context))->first) = *(&(*(&__context))->last) = (list_node * )__newS(24, __nullcTR[107]);
		...
		*(&(*(&(*(&__context))->last))->next) = (list_node * )__newS(24, __nullcTR[107]);
	...
	*(&(*(&(*(&__context))->last))->parent) = __nullcMakeAutoRef((void*)*(&__context), __nullcTR[109]);
}
void  list__push_front_void_ref_auto_ref_(NULLCRef elem_0, list * __context)
{
	...
	if(!(*(&(*(&__context))->first)))
	{
		...
		*(&(*(&(*(&__context))->first))->prev) = (list_node * )__newS(24, __nullcTR[107]);
...
void  list__insert_void_ref_list_node_ref_auto_ref_(list_node * it_0, NULLCRef elem_4, list * __context)
{
	...
	{
		assert(0, __operatorAdd(__operatorAdd(__operatorAdd(__operatorAdd((memcpy((&__temp14_20)->ptr, "list::insert argument type (\x0\x0\x0\x0", 32), __makeNullcArray<char >(&__temp14_20, 29)), (*(&__temp13_16) = typeid__(*(&elem_4), (void*)0), typeid__name__char___ref__(&__temp13_16)), (void*)0), (memcpy((&__temp15_52)->ptr, ") differs from list element type (\x0\x0", 36), __makeNullcArray<char >(&__temp15_52, 35)), (void*)0), typeid__name__char___ref__(&(*(&__context))->elemType), (void*)0), (memcpy((&__temp16_88)->ptr, ")\x0\x0\x0", 4), __makeNullcArray<char >(&__temp16_88, 2)), (void*)0), (void*)0);
	}
	if(((list * )__nullcGetAutoRef(*(&(*(&it_0))->parent), __nullcTR[109])) != (*(&__context)))
	{
	...
	*(&next_140) = *(&(*(&it_0))->next);
	*(&(*(&it_0))->next) = (list_node * )__newS(24, __nullcTR[107]);
	*(&(*(&(*(&it_0))->next))->elem) = isPointer(*(&(*(&__context))->elemType), (void*)0) ? *(&elem_4) : duplicate(*(&elem_4), (void*)0);
	*(&(*(&(*(&it_0))->next))->prev) = *(&it_0);
	*(&(*(&(*(&it_0))->next))->next) = *(&next_140);
	*(&(*(&(*(&it_0))->next))->parent) = __nullcMakeAutoRef((void*)*(&__context), __nullcTR[109]);
	if(*(&next_140))
	{
...
{
	char_32_ __temp19_4;
	assert((*(&(*(&__context))->first)) != (list_node * )((void * )(0)), (memcpy((&__temp19_4)->ptr, "list::back called on empty list\x0", 32), __makeNullcArray<char >(&__temp19_4, 32)), (void*)0);
	return *(&(*(&(*(&__context))->last))->elem);
}
NULLCRef  list__front_auto_ref_ref__(list * __context)
{
	char_33_ __temp20_4;
	assert((*(&(*(&__context))->first)) != (list_node * )((void * )(0)), (memcpy((&__temp20_4)->ptr, "list::front called on empty list\x0\x0\x0\x0", 36), __makeNullcArray<char >(&__temp20_4, 33)), (void*)0);
...
int __init_std_list_nc()
{
	...
	__nullcTR[107] = __nullcRegisterType(2811333126u, "list_node", 24, __nullcTR[0], 4, NULLC_CLASS);
	__nullcTR[108] = __nullcRegisterType(3385236355u, "list_node ref", 4, __nullcTR[107], 1, NULLC_POINTER);
	__nullcTR[109] = __nullcRegisterType(2090473057u, "list", 16, __nullcTR[0], 4, NULLC_CLASS);
	__nullcTR[110] = __nullcRegisterType(1559940649u, "auto ref ref()", 8, __nullcTR[0], 0, NULLC_FUNCTION);
	__nullcTR[111] = __nullcRegisterType(988947328u, "list_node ref ref", 4, __nullcTR[108], 1, NULLC_POINTER);
	__nullcTR[112] = __nullcRegisterType(3865797117u, "list_node ref ref ref", 4, __nullcTR[111], 1, NULLC_POINTER);
	__nullcTR[113] = __nullcRegisterType(3466845534u, "list ref", 4, __nullcTR[109], 1, NULLC_POINTER);
	__nullcTR[114] = __nullcRegisterType(235068123u, "list ref ref", 4, __nullcTR[113], 1, NULLC_POINTER);
	__nullcTR[115] = __nullcRegisterType(156721184u, "char[32]", 32, __nullcTR[6], 32, NULLC_ARRAY);
	__nullcTR[116] = __nullcRegisterType(2824728221u, "char[32] ref", 4, __nullcTR[115], 1, NULLC_POINTER);
	__nullcTR[117] = __nullcRegisterType(156721283u, "char[35]", 36, __nullcTR[6], 35, NULLC_ARRAY);
	__nullcTR[118] = __nullcRegisterType(2942134400u, "char[35] ref", 4, __nullcTR[117], 1, NULLC_POINTER);
	__nullcTR[119] = __nullcRegisterType(3258512237u, "char[2]", 4, __nullcTR[6], 2, NULLC_ARRAY);
	__nullcTR[120] = __nullcRegisterType(1396858986u, "char[2] ref", 4, __nullcTR[119], 1, NULLC_POINTER);
	__nullcTR[121] = __nullcRegisterType(3930092916u, "void ref(typeid)", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[122] = __nullcRegisterType(3077459672u, "list ref ref ref", 4, __nullcTR[114], 1, NULLC_POINTER);
	__nullcTR[123] = __nullcRegisterType(3807592574u, "list ref(typeid)", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[124] = __nullcRegisterType(1812738619u, "void ref(auto ref)", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	...
	__nullcTR[130] = __nullcRegisterType(156722438u, "char[47]", 48, __nullcTR[6], 47, NULLC_ARRAY);
	__nullcTR[131] = __nullcRegisterType(16905859u, "char[47] ref", 4, __nullcTR[130], 1, NULLC_POINTER);
	__nullcTR[132] = __nullcRegisterType(2550440515u, "void ref(list_node ref)", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[133] = __nullcRegisterType(3221817553u, "list_node ref ref()", 8, __nullcTR[0], 0, NULLC_FUNCTION);
	__nullcTR[134] = __nullcRegisterType(2965682314u, "list_iterator", 4, __nullcTR[0], 1, NULLC_CLASS);
	__nullcTR[135] = __nullcRegisterType(2117430279u, "list_iterator ref", 4, __nullcTR[134], 1, NULLC_POINTER);
	__nullcTR[136] = __nullcRegisterType(3496029590u, "list_iterator ref(list_node ref)", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[137] = __nullcRegisterType(3779104536u, "list_iterator ref()", 8, __nullcTR[0], 0, NULLC_FUNCTION);
	__nullcTR[138] = __nullcRegisterType(865965572u, "list_iterator ref ref", 4, __nullcTR[135], 1, NULLC_POINTER);
	__nullcTR[139] = __nullcRegisterType(1423210113u, "list_iterator ref ref ref", 4, __nullcTR[138], 1, NULLC_POINTER);
	...
	__nullcRegisterMembers(__nullcTR[107], 4, __nullcTR[108], 0, __nullcTR[108], 4, __nullcTR[7], 8, __nullcTR[7], 16);
	__nullcRegisterMembers(__nullcTR[109], 4, __nullcTR[8], 0, __nullcTR[4], 4, __nullcTR[108], 8, __nullcTR[108], 12);
	__nullcRegisterMembers(__nullcTR[134], 1, __nullcTR[108], 0);
	__nullcFR[0] = 0;
	__nullcFR[1] = 0;
	__nullcFR[2] = 0;
	__nullcFR[3] = 0;
	...
	__nullcFR[86] = __nullcRegisterFunction("list_node__value__auto_ref_ref__", (void*)list_node__value__auto_ref_ref__, 108u);
	__nullcFR[87] = __nullcRegisterFunction("list_node__value__auto_ref_ref_auto_ref_", (void*)list_node__value__auto_ref_ref_auto_ref_, 108u);
	__nullcFR[88] = __nullcRegisterFunction("list__list_void_ref_typeid_", (void*)list__list_void_ref_typeid_, 113u);
	__nullcFR[89] = __nullcRegisterFunction("list__", (void*)list__, 31u);
	__nullcFR[90] = __nullcRegisterFunction("list__push_back_void_ref_auto_ref_", (void*)list__push_back_void_ref_auto_ref_, 113u);
	__nullcFR[91] = __nullcRegisterFunction("list__push_front_void_ref_auto_ref_", (void*)list__push_front_void_ref_auto_ref_, 113u);
	__nullcFR[92] = __nullcRegisterFunction("list__insert_void_ref_list_node_ref_auto_ref_", (void*)list__insert_void_ref_list_node_ref_auto_ref_, 113u);
	__nullcFR[93] = __nullcRegisterFunction("list__erase_void_ref_list_node_ref_", (void*)list__erase_void_ref_list_node_ref_, 113u);
	__nullcFR[94] = __nullcRegisterFunction("list__clear_void_ref__", (void*)list__clear_void_ref__, 113u);
	__nullcFR[95] = __nullcRegisterFunction("list__back_auto_ref_ref__", (void*)list__back_auto_ref_ref__, 113u);
	__nullcFR[96] = __nullcRegisterFunction("list__front_auto_ref_ref__", (void*)list__front_auto_ref_ref__, 113u);
	__nullcFR[97] = __nullcRegisterFunction("list__begin_list_node_ref_ref__", (void*)list__begin_list_node_ref_ref__, 113u);
	__nullcFR[98] = __nullcRegisterFunction("list__end_list_node_ref_ref__", (void*)list__end_list_node_ref_ref__, 113u);
	__nullcFR[99] = __nullcRegisterFunction("list__empty_int_ref__", (void*)list__empty_int_ref__, 113u);
	__nullcFR[100] = __nullcRegisterFunction("list_iterator__", (void*)list_iterator__, 31u);
	__nullcFR[101] = __nullcRegisterFunction("list__start_list_iterator_ref__", (void*)list__start_list_iterator_ref__, 113u);
	__nullcFR[102] = __nullcRegisterFunction("list_iterator__next_auto_ref_ref__", (void*)list_iterator__next_auto_ref_ref__, 135u);
	__nullcFR[103] = __nullcRegisterFunction("list_iterator__hasnext_int_ref__", (void*)list_iterator__hasnext_int_ref__, 135u);
	__nullcFR[104] = __nullcRegisterFunction("__list_type_88", (void*)__list_type_88, 31u);
	__nullcFR[105] = __nullcRegisterFunction("__list_type_89", (void*)__list_type_89, 31u);
}
