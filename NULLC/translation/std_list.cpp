...
int __init_std_list_nc()
{
	...
	__nullcFR[83] = __nullcRegisterFunction("list_node__value__auto_ref_ref__", (void*)list_node__value__auto_ref_ref__);
	__nullcFR[84] = 0;
	__nullcFR[85] = 0;
	__nullcFR[86] = __nullcRegisterFunction("list__push_back_void_ref_auto_ref_", (void*)list__push_back_void_ref_auto_ref_);
	__nullcFR[87] = __nullcRegisterFunction("list__push_front_void_ref_auto_ref_", (void*)list__push_front_void_ref_auto_ref_);
	__nullcFR[88] = __nullcRegisterFunction("list__insert_void_ref_list_node_ref_auto_ref_", (void*)list__insert_void_ref_list_node_ref_auto_ref_);
	__nullcFR[89] = __nullcRegisterFunction("list__erase_void_ref_list_node_ref_", (void*)list__erase_void_ref_list_node_ref_);
	__nullcFR[90] = __nullcRegisterFunction("list__clear_void_ref__", (void*)list__clear_void_ref__);
	__nullcFR[91] = __nullcRegisterFunction("list__back_auto_ref_ref__", (void*)list__back_auto_ref_ref__);
	__nullcFR[92] = __nullcRegisterFunction("list__front_auto_ref_ref__", (void*)list__front_auto_ref_ref__);
	__nullcFR[93] = __nullcRegisterFunction("list__begin_list_node_ref_ref__", (void*)list__begin_list_node_ref_ref__);
	__nullcFR[94] = __nullcRegisterFunction("list__end_list_node_ref_ref__", (void*)list__end_list_node_ref_ref__);
	__nullcFR[95] = __nullcRegisterFunction("list__empty_int_ref__", (void*)list__empty_int_ref__);
	__nullcFR[96] = __nullcRegisterFunction("list_iterator__", (void*)list_iterator__);
	__nullcFR[97] = __nullcRegisterFunction("list__start_list_iterator_ref__", (void*)list__start_list_iterator_ref__);
	__nullcFR[98] = __nullcRegisterFunction("list_iterator__next_auto_ref_ref__", (void*)list_iterator__next_auto_ref_ref__);
	__nullcFR[99] = __nullcRegisterFunction("list_iterator__hasnext_int_ref__", (void*)list_iterator__hasnext_int_ref__);
}
