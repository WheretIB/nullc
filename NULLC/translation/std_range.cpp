...
int __range_step_73(void* unused);
range_iterator  range_iterator__start_range_iterator_ref__(range_iterator * __context)
{
	return *(*(&__context));
}
...
int __init_std_range_nc()
{
	...
	__nullcTR[100] = __nullcRegisterType(3246223675u, "range_iterator", 12, __nullcTR[0], 3, NULLC_CLASS);
	__nullcTR[101] = __nullcRegisterType(957158712u, "range_iterator ref", 4, __nullcTR[100], 1, NULLC_POINTER);
	__nullcTR[102] = __nullcRegisterType(2006478773u, "range_iterator ref ref", 4, __nullcTR[101], 1, NULLC_POINTER);
	__nullcTR[103] = __nullcRegisterType(2963753097u, "range_iterator ref()", 8, __nullcTR[0], 0, NULLC_FUNCTION);
	__nullcTR[104] = __nullcRegisterType(2954242914u, "range_iterator ref(int,int,int)", 8, __nullcTR[0], 3, NULLC_FUNCTION);
	...
	__nullcRegisterMembers(__nullcTR[100], 3, __nullcTR[4], 0, __nullcTR[4], 4, __nullcTR[4], 8);
	__nullcFR[0] = 0;
	__nullcFR[1] = 0;
	__nullcFR[2] = 0;
	__nullcFR[3] = 0;
	...
	__nullcFR[70] = __nullcRegisterFunction("range_iterator__start_range_iterator_ref__", (void*)range_iterator__start_range_iterator_ref__, 101u, 2);
	__nullcFR[71] = __nullcRegisterFunction("range_iterator__next_int_ref__", (void*)range_iterator__next_int_ref__, 101u, 2);
	__nullcFR[72] = __nullcRegisterFunction("range_iterator__hasnext_int_ref__", (void*)range_iterator__hasnext_int_ref__, 101u, 2);
	__nullcFR[73] = __nullcRegisterFunction("range", (void*)range, 31u, 0);
	__nullcFR[74] = __nullcRegisterFunction("__range_step_73", (void*)__range_step_73, 31u, 0);
}
