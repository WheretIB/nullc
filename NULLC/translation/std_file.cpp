...
int __init_std_file_nc()
{
	...
	__nullcTR[86] = __nullcRegisterType(2089107205u, "File", 8, __nullcTR[0], 2, NULLC_CLASS);
	__nullcTR[87] = __nullcRegisterType(1963509203u, "File ref()", 8, __nullcTR[0], 0, NULLC_FUNCTION);
	__nullcTR[88] = __nullcRegisterType(1505295979u, "File ref(char[],char[])", 8, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[89] = __nullcRegisterType(3565315197u, "void ref(char[],char[])", 8, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[90] = __nullcRegisterType(2786737248u, "void ref(char ref)", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[91] = __nullcRegisterType(1406213874u, "void ref(short ref)", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[92] = __nullcRegisterType(3241370989u, "void ref(int ref)", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[93] = __nullcRegisterType(55795314u, "void ref(long ref)", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[94] = __nullcRegisterType(3566959480u, "void ref(float ref)", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[95] = __nullcRegisterType(1140524797u, "void ref(double ref)", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	...
	__nullcRegisterMembers(__nullcTR[86], 2, __nullcTR[4], 0, __nullcTR[9], 4);
	__nullcFR[0] = 0;
	__nullcFR[1] = 0;
	__nullcFR[2] = 0;
	__nullcFR[3] = 0;
	...
	__nullcFR[58] = 0;
	__nullcFR[59] = 0;
	__nullcFR[60] = __nullcRegisterFunction("File__Open_void_ref_char___char___", (void*)File__Open_void_ref_char___char___, 4294967295u);
	__nullcFR[61] = __nullcRegisterFunction("File__Close_void_ref__", (void*)File__Close_void_ref__, 4294967295u);
	__nullcFR[62] = __nullcRegisterFunction("File__Opened_int_ref__", (void*)File__Opened_int_ref__, 4294967295u);
	__nullcFR[63] = __nullcRegisterFunction("File__Write_void_ref_char_", (void*)File__Write_void_ref_char_, 4294967295u);
	__nullcFR[64] = __nullcRegisterFunction("File__Write_void_ref_short_", (void*)File__Write_void_ref_short_, 4294967295u);
	__nullcFR[65] = __nullcRegisterFunction("File__Write_void_ref_int_", (void*)File__Write_void_ref_int_, 4294967295u);
	__nullcFR[66] = __nullcRegisterFunction("File__Write_void_ref_long_", (void*)File__Write_void_ref_long_, 4294967295u);
	__nullcFR[67] = __nullcRegisterFunction("File__Write_void_ref_float_", (void*)File__Write_void_ref_float_, 4294967295u);
	__nullcFR[68] = __nullcRegisterFunction("File__Write_void_ref_double_", (void*)File__Write_void_ref_double_, 4294967295u);
	__nullcFR[69] = __nullcRegisterFunction("File__Read_void_ref_char_ref_", (void*)File__Read_void_ref_char_ref_, 4294967295u);
	__nullcFR[70] = __nullcRegisterFunction("File__Read_void_ref_short_ref_", (void*)File__Read_void_ref_short_ref_, 4294967295u);
	__nullcFR[71] = __nullcRegisterFunction("File__Read_void_ref_int_ref_", (void*)File__Read_void_ref_int_ref_, 4294967295u);
	__nullcFR[72] = __nullcRegisterFunction("File__Read_void_ref_long_ref_", (void*)File__Read_void_ref_long_ref_, 4294967295u);
	__nullcFR[73] = __nullcRegisterFunction("File__Read_void_ref_float_ref_", (void*)File__Read_void_ref_float_ref_, 4294967295u);
	__nullcFR[74] = __nullcRegisterFunction("File__Read_void_ref_double_ref_", (void*)File__Read_void_ref_double_ref_, 4294967295u);
	__nullcFR[75] = __nullcRegisterFunction("File__Read_void_ref_char___", (void*)File__Read_void_ref_char___, 4294967295u);
	__nullcFR[76] = __nullcRegisterFunction("File__Write_void_ref_char___", (void*)File__Write_void_ref_char___, 4294967295u);
	__nullcFR[77] = __nullcRegisterFunction("File__Print_void_ref_char___", (void*)File__Print_void_ref_char___, 4294967295u);
