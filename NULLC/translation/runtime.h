...
bool is_derived_from_bool_ref_auto_ref_typeid_(NULLCRef derived, unsigned base, void* __context);
void* __assert_derived_from_void_ref_ref_void_ref_typeid_(void* derived, unsigned base, void* __context);
