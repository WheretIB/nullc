...
int __init_std_gc_nc()
{
	...
	__nullcRegisterMembers(__nullcTR[84], 0);
	__nullcRegisterGlobal((void*)&GC, __nullcTR[84]);
	__nullcFR[0] = 0;
	__nullcFR[1] = 0;
	__nullcFR[2] = 0;
	__nullcFR[3] = 0;
	...
	__nullcFR[55] = __nullcRegisterFunction("NamespaceGC__CollectMemory_void_ref__", (void*)NamespaceGC__CollectMemory_void_ref__, 4294967295u);
	__nullcFR[56] = __nullcRegisterFunction("NamespaceGC__UsedMemory_int_ref__", (void*)NamespaceGC__UsedMemory_int_ref__, 4294967295u);
	__nullcFR[57] = __nullcRegisterFunction("NamespaceGC__MarkTime_double_ref__", (void*)NamespaceGC__MarkTime_double_ref__, 4294967295u);
	__nullcFR[58] = __nullcRegisterFunction("NamespaceGC__CollectTime_double_ref__", (void*)NamespaceGC__CollectTime_double_ref__, 4294967295u);
