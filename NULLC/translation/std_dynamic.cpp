...
void  eval(NULLCArray<char > code_0, void* unused)
{
	...
	override(__nullcMakeAutoRef((void*)(*(&__temp1_12) = (	__nullcMakeFunction(__nullcFR[60], (void*)0u)), &__temp1_12), __nullcTR[48]), *(&code_0), (void*)0);
	eval_stub((void*)0);
}
int __init_std_dynamic_nc()
{
	...
	__nullcTR[86] = __nullcRegisterType(3364104125u, "void ref(auto ref,auto ref)", 8, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[87] = __nullcRegisterType(3096107997u, "void ref(auto ref,char[])", 8, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[88] = __nullcRegisterType(2767335131u, "void ref(char[])", 8, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[89] = __nullcRegisterType(2498703266u, "void ref() ref", 4, __nullcTR[48], 1, NULLC_POINTER);
	...
	__nullcFR[58] = 0;
	__nullcFR[59] = 0;
	__nullcFR[60] = __nullcRegisterFunction("eval_stub", (void*)eval_stub, 31u);
	__nullcFR[61] = __nullcRegisterFunction("eval", (void*)eval, 31u);
}
