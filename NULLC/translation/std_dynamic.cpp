...
{
	NULLCFuncPtr<__typeProxy_void_ref__> __temp1_20;
	override(__nullcMakeAutoRef((void*)(*(&__temp1_20) = (	(NULLCFuncPtr<__typeProxy_void_ref__> )__nullcMakeFunction(__nullcFR[74], (void*)0u)), &__temp1_20), __nullcTR[54]), *(&code_0), (void*)0);
	eval_stub((void*)0);
}
int __init_std_dynamic_nc()
{
	...
	__nullcTR[96] = __nullcRegisterType(3096107997u, "void ref(auto ref,char[])", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[97] = __nullcRegisterType(2767335131u, "void ref(char[])", 12, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[98] = __nullcRegisterType(2498703266u, "void ref() ref", 8, __nullcTR[54], 1, NULLC_POINTER);
	...
	__nullcFR[72] = 0;
	__nullcFR[73] = 0;
	__nullcFR[74] = __nullcRegisterFunction("eval_stub", (void*)eval_stub, 31u, 0);
	__nullcFR[75] = __nullcRegisterFunction("eval", (void*)eval, 31u, 0);
}
