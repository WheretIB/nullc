...
{
	int ptr[3];
	int_3_ & set(unsigned index, int const & val){ ptr[index] = val; return *this; }
};
...
{
	__StdIO___func1_84_cls * __StdIO___func1_84_ext_20;
	NULLCFuncPtr<__typeProxy_char___ref_StdNonTerminatedTag_> __nullcRetVar0;
	__nullcRetVar0 = (	(__StdIO___func1_84_ext_20 = (__StdIO___func1_84_cls * )__newS(20, __nullcTR[109])),
	(*(int**)((char*)__StdIO___func1_84_ext_20 + 0) = (int*)&x_0),
	(*(int**)((char*)__StdIO___func1_84_ext_20 + 8) = (int*)__upvalue_83_x_0),
	(*(int*)((char*)__StdIO___func1_84_ext_20 + 16) = 12),
	(__upvalue_83_x_0 = (__nullcUpvalue*)((int*)__StdIO___func1_84_ext_20 + 0)),
	(NULLCFuncPtr<__typeProxy_char___ref_StdNonTerminatedTag_> )__nullcMakeFunction(__nullcFR[84], __StdIO___func1_84_ext_20));
...
{
	char_3_ __temp1_16;
	Print((memcpy((&__temp1_16)->ptr, "\xd\xa\x0\x0", 4), __makeNullcArray<char >(&__temp1_16, 3)), (void*)0);
	return *(&out_0);
}
...
int __init_std_io_nc()
{
	...
	__nullcTR[96] = __nullcRegisterType(2767335131u, "void ref(char[])", 12, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[97] = __nullcRegisterType(3255288871u, "void ref(int,int)", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[98] = __nullcRegisterType(69713196u, "void ref(long,int)", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[99] = __nullcRegisterType(709988916u, "int ref(char[])", 12, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[100] = __nullcRegisterType(3241370989u, "void ref(int ref)", 12, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[101] = __nullcRegisterType(1591343073u, "void ref(int ref,int ref)", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	...
	__nullcTR[107] = __nullcRegisterType(2247820165u, "StdIO ref", 8, __nullcTR[106], 1, NULLC_POINTER);
	__nullcTR[108] = __nullcRegisterType(2550674952u, "char[] ref(StdNonTerminatedTag)", 12, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[109] = __nullcRegisterType(180207047u, "__StdIO::$func1_84_cls", 20, __nullcTR[0], 2, NULLC_CLASS);
	__nullcTR[110] = __nullcRegisterType(81026107u, "int[3]", 12, __nullcTR[4], 3, NULLC_ARRAY);
	__nullcTR[111] = __nullcRegisterType(2339948484u, "__StdIO::$func1_84_cls ref", 8, __nullcTR[109], 1, NULLC_POINTER);
	__nullcTR[112] = __nullcRegisterType(2792523841u, "__StdIO::$func1_84_cls ref ref", 8, __nullcTR[111], 1, NULLC_POINTER);
	__nullcTR[113] = __nullcRegisterType(2537081868u, "char[] ref(StdNonTerminatedTag) ref(char[])", 12, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[114] = __nullcRegisterType(2770388008u, "StdBase ref", 8, __nullcTR[105], 1, NULLC_POINTER);
	__nullcTR[115] = __nullcRegisterType(1821960228u, "StdBase ref(int)", 12, __nullcTR[0], 1, NULLC_FUNCTION);
	__nullcTR[116] = __nullcRegisterType(231959531u, "StdOut ref(StdOut,StdBase)", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[117] = __nullcRegisterType(1906324325u, "StdOut ref", 8, __nullcTR[102], 1, NULLC_POINTER);
	__nullcTR[118] = __nullcRegisterType(211946088u, "StdOut ref(StdOut,char[] ref(StdNonTerminatedTag))", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[119] = __nullcRegisterType(949711617u, "StdNonTerminatedTag ref", 8, __nullcTR[104], 1, NULLC_POINTER);
	__nullcTR[120] = __nullcRegisterType(769095813u, "char[] ref(StdNonTerminatedTag) ref", 8, __nullcTR[108], 1, NULLC_POINTER);
	__nullcTR[121] = __nullcRegisterType(1457376283u, "StdOut ref(StdOut,char[])", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[122] = __nullcRegisterType(2142474658u, "StdOut ref(StdOut,const_string)", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[123] = __nullcRegisterType(1732329455u, "StdOut ref(StdOut,StdEndline)", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[124] = __nullcRegisterType(3258512270u, "char[3]", 4, __nullcTR[6], 3, NULLC_ARRAY);
	__nullcTR[125] = __nullcRegisterType(1435994379u, "char[3] ref", 8, __nullcTR[124], 1, NULLC_POINTER);
	__nullcTR[126] = __nullcRegisterType(3306372739u, "StdOut ref(StdOut,char)", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[127] = __nullcRegisterType(2182824208u, "StdOut ref(StdOut,int)", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[128] = __nullcRegisterType(3045954208u, "StdOut ref(StdOut,double)", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	__nullcTR[129] = __nullcRegisterType(3317311381u, "StdOut ref(StdOut,long)", 12, __nullcTR[0], 2, NULLC_FUNCTION);
	...
	__nullcRegisterMembers(__nullcTR[109], 2, __nullcTR[17], 0, __nullcTR[110], 8);
